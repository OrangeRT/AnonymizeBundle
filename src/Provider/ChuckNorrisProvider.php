...
namespace OrangeRT\AnonymizeBundle\Provider;
 ...
 * @package OrangeRT\AnonymizeBundle\Provider
 *
 * Ported from https://github.com/jenkinsci/chucknorris-plugin/blob/master/src/main/java/hudson/plugins/chucknorris/FactGenerator.java
 */
class ChuckNorrisProvider extends Base
{
    const FACTS = array(
    ...
    /**
     * @return mixed Returns a random Chuck Norris fact.
     */
    public function fact()
    {
        return $this->generator->randomElement(static::FACTS);
    }
